/**
 * Server-side migration script using Strapi Entity Service
 * This runs inside Strapi and has direct access to the database
 */
...
module.exports = async ({ strapi }) => {
  ...
  console.log(`\n✅ Migration complete!`);
  console.log(`\n📝 Verify in Strapi admin: http://localhost:1337/admin`);
};
